...
#'
#' @return a data.frame with feature types and their corresponding node
#' @export
#'
#' @examples
#' 
...
aggr.fea.voro <- function(nodes, features){
    ## Creating global window to ensure all points will be included
    global_win <- spatstat::boundingbox(
        ...
        ))              # to avoid exclusion of finds on the border
    ## Using Voronoi Tesselation to assign points to nodes
